...
@click.option("--num_encoder_layers", type=int, default=3)
@click.option("--num_decoder_layers", type=int, default=3)
@click.option("--dim_feedforward", type=int, default=1024)
